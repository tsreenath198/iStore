(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["profits-profits-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProfitsRoutingModule = /** @class */ (function () {
                function ProfitsRoutingModule() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProfitsComponent = /** @class */ (function () {
                function ProfitsComponent(http) {
                    this.http = http;
                ...
                ProfitsComponent.prototype.ngOnInit = function () {
                    this.setCurrentDates();
                    this.getTotalData();
                };
                ProfitsComponent.prototype.setCurrentDates = function () {
                ...
                //   });
                // }
                ProfitsComponent.prototype.getTotalData = function () {
                    var _this = this;
                    this.http.get(this.URL.ProfitGetCategory + this.groupReq.fromDate + '&toDate=' + this.groupReq.toDate).subscribe(function (resp) {
                        _this.profitsCategoriesList = resp;
                    });
                };
                ProfitsComponent.prototype.getProductsData = function (catName) {
                    var _this = this;
                    this.profitsProductsList = [];
                    this.http
                        ...
                        _this.profitsProductsList = resp;
                    });
                };
                ProfitsComponent.prototype.setDates = function () {
                    this.setCurrentDates();
            ...
            ProfitsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProfitsModule = /** @class */ (function () {
                function ProfitsModule() {
                }
...
//# sourceMappingURL=profits-profits-module-es5.js.map
//# sourceMappingURL=profits-profits-module-es5.js.map