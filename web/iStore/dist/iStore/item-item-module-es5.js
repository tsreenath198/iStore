...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["item-item-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ItemComponent = /** @class */ (function () {
                function ItemComponent(storageService, http, modalService, toastr) {
                ...
                ItemComponent.prototype.ngOnInit = function () {
                    ...
                    if (this.storageService.orderId) {
                        ...
                        this.http
                            ...
                            var temp = resp;
                            _this.itemList = temp.items;
                            _this.totalBill = temp.total;
                            _this.customerDetails = temp.contact;
                            _this.paymentMode = temp.paymentMode;
                            _this.invoiceDate = temp.invoiceDate;
                            _this.orderType = temp.orderType;
                        });
                    }
                };
                ItemComponent.prototype.getCustomerList = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 1:
                                    _a.customerList = _b.sent(); //Do you own cast here
                                    return [2 /*return*/, this.customerList];
                            }
                        });
                    });
                };
                ItemComponent.prototype.getProductList = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, this.http
                                            ...
                                            .then(function (resp) { return resp; })];
                                case 1:
                                    _a.productList = _b.sent(); //Do you own cast here
                                    this.filterProductList = this.productList;
                                    if (this.filterProductList) {
                                        this.setFilter();
                                    }
                                    return [2 /*return*/, this.productList];
                            }
                        });
                    });
                };
                ItemComponent.prototype.getCategoryList = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, this.http
                                            ...
                                            .then(function (resp) { return resp; })];
                                case 1:
                                    _a.categoryList = _b.sent(); //Do you own cast here
                                    return [2 /*return*/, this.categoryList];
                            }
                        });
                    });
                };
                ItemComponent.prototype.setFilter = function () {
                    var _this = this;
                    this.selectedCategory = "Cup";
                    var item = this.categoryList.filter(function (item) { return item.name == _this.selectedCategory; });
                    this.filter(item[0].id, item[0].name);
                };
                ItemComponent.prototype.addToList = function (p) {
                    if (p.inventory <= 0) {
                        window.alert("Item out of stock!");
                    }
                    else {
                        var index = this.itemList.findIndex(function (i) { return i.product.id === p.id; });
                        if (index == -1) {
                ...
                ItemComponent.prototype.addToModel = function (p) {
                    var bill = {};
                    bill.price = p.price;
                    bill.product = p;
                ...
                ItemComponent.prototype.calculateSingleItemTotal = function (p) {
                    return (p.quantity * p.product.price * (100 - p.discount)) / 100;
                };
                ItemComponent.prototype.calculateOrderTotal = function (p) {
                    var _this = this;
                    this.totalBill = 0;
                    p.forEach(function (i) { return (_this.totalBill += i.total); });
                };
                ItemComponent.prototype.setTotal = function (p) {
                    p.total = Math.ceil((p.quantity * p.price * (100 - p.discount)) / 100);
                    this.calculateOrderTotal(this.itemList);
                };
                ItemComponent.prototype.generateBill = function (event) {
                    var _this = this;
                    var finalOrder = {};
                    ...
                    this.http.post(finalOrder, this.url.OrderCreate).subscribe(function (resp) {
                ...
                ItemComponent.prototype.update = function () {
                    ...
                    this.http.update(finalOrder, this.url.OrderUpdate).subscribe(function (resp) {
                        // this.printingBill=resp as any;
                        // this.setPrintingBill(event);
                        window.alert("Updated successfully.");
                        _this.cancelBill();
                        _this.updateMode = false;
                        _this.storageService.orderId = null;
                    });
                };
                ItemComponent.prototype.openPaymentOption = function (event) {
                    this.open(event);
                };
                ItemComponent.prototype.proceedToPrint = function (event) {
                ...
                /**Printing bill model */
                ItemComponent.prototype.setPrintingBill = function (billContent) {
                    var _this = this;
                    this.http.get(this.url.OrderGetId).subscribe(function (resp) {
                        _this.printingBill["id"] = resp;
                    });
                ...
                ItemComponent.prototype.cancelBill = function () {
                    this.itemList = [];
                    this.totalBill = 0.0;
                ...
                /**Filter */
                ItemComponent.prototype.filter = function (categoryId, categoryName) {
                    this.selectedCategory = categoryName;
                    var temp = [];
                    this.filterProductList.filter(function (product) {
                ...
                ItemComponent.prototype.getDismissReason = function (reason) {
                ...
                ItemComponent.prototype.removeItemFromBill = function (i) {
                    this.itemList.splice(i, 1);
                    this.calculateOrderTotal(this.itemList);
                };
                ItemComponent.prototype.alert = function () {
                    window.alert("Name or Payment mode is empty.");
                };
                ItemComponent.prototype.calculateBill = function (event) {
                    this.giveAmount = 0;
                    this.giveAmount = Math.floor(event.target.value - this.totalBill);
                };
                ItemComponent.prototype.calculateDiscount = function () {
                    if (this.totalDiscount > 0) {
                        this.removeDiscountFromIndividual();
                        var temp = (this.totalBill * this.totalDiscount) / 100;
                ...
                ItemComponent.prototype.removeDiscountFromIndividual = function () {
                ...
                ItemComponent.prototype.onChange = function (details) {
                    var _this = this;
                    this.customerList.forEach(function (data) {
                        if (data.name == _this.customerDetails.name) {
                            _this.customerDetails.phone = data.phone;
                        }
                    });
                };
