(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["report-report-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ReportComponent = /** @class */ (function () {
                function ReportComponent(router, http, modalService, storageService) {
                    this.router = router;
                    this.http = http;
                ...
                ReportComponent.prototype.getTotalData = function () {
                    ...
                    this.http
                        ...
                        _this.groupByData = resp;
                    });
                };
                ReportComponent.prototype.valueBy1 = function (data) {
                    var _this = this;
                    this.valueByData2 = [];
                    this.finalBills = [];
                    console.log(data);
                    ...
                    if (data.type == "day") {
                        ...
                        this.http.get(reqUrl).subscribe(function (resp) {
                            _this.valueByData2 = resp;
                            document.body.style.cursor = "default";
                        });
                    }
                };
                ReportComponent.prototype.groupBy = function (data) {
                    var _this = this;
                    this.valueByData = [];
                    this.valueByData2 = [];
                    this.finalBills = [];
                    ...
                    if (data.type == "day") {
                        ...
                        reqUrl =
                            this.URL.ReportByValue +
                                ...
                                this.groupReq.toDate;
                        this.http.get(reqUrl).subscribe(function (resp) {
                            _this.valueByData = resp;
                        });
                    }
                };
                ReportComponent.prototype.valueBy2 = function (data) {
                    this.showTable = "cardBody2";
                    this.getDateBills(data);
                };
                ReportComponent.prototype.getDateBills = function (data) {
                    var _this = this;
                    this.finalBills = [];
                    this.getBillURLData = data;
                    var reqUrl = this.URL.ReportGetBills +
                        data.month +
                        "&value=" +
                        data.value +
                        "&year=" +
                        data.year;
                    this.http.get(reqUrl).subscribe(function (resp) {
                        _this.finalBills = resp;
                    });
                };
                ReportComponent.prototype.delete = function (order) {
                    var _this = this;
                    if (window.confirm("Do you want to delete the bill?")) {
                        this.http.delete(this.URL.OrderDelete + order.id).subscribe(function (resp) {
                            _this.getDateBills(_this.getBillURLData);
                            //this.filterData(date);
                            window.alert("Bill deleted successfully");
                        });
                    }
                };
                ReportComponent.prototype.edit = function (order) {
                    this.storageService.orderId = order.id;
                    this.router.navigate(["layout/bill"]);
                };
                ReportComponent.prototype.openPopup = function (order, billContent) {
                ...
                // }
                ReportComponent.prototype.setDates = function () {
                    this.setCurrentDates();
