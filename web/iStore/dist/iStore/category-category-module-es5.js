        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CategoryComponent = /** @class */ (function () {
                ...
                CategoryComponent.prototype.getAll = function () {
                    var _this = this;
                    this.http.get(this.url.CategoryGetAll).subscribe(function (resp) {
                        _this.categoryList = resp;
                    });
                };
                CategoryComponent.prototype.commonInHTTP = function () {
                    this.getAll();
                    this.model = {};
                    this.model.activeStatus = 0;
                    this.model.rawMaterial = false;
                };
                CategoryComponent.prototype.create = function (form) {
                    var _this = this;
                    this.http
                        .post(this.model, this.url.CategoryCreate)
                        .subscribe(function (resp) {
                        _this.commonInHTTP();
                        _this.model.activeStatus = 0;
                        _this.model.rawMaterial = false;
                    });
                };
                CategoryComponent.prototype.update = function () {
                    var _this = this;
                    this.http.update(this.model, this.url.CategoryUpdate).subscribe(function (resp) {
                        _this.commonInHTTP();
                        _this.actionType = "C";
                    });
                };
                CategoryComponent.prototype.new = function (form) {
                    this.model = {};
                    this.model.activeStatus = 0;
                    this.model.rawMaterial = false;
                    this.actionType = "C";
                };
                CategoryComponent.prototype.getById = function (id) {
                    var _this = this;
                    this.http.get(this.url.CategoryGetById + id).subscribe(function (resp) {
                        _this.model = resp;
                        _this.actionType = "U";
                    });
                };
                CategoryComponent.prototype.delete = function (category) {
                    ...
                    if (window.confirm("Do you want to delete " + category.name + "?")) {
                        this.http.delete(this.url.CategoryDelete + category.id).subscribe(function (resp) {
                            _this.getAll();
                        });
                    }
                };
